...
export default {
  // Nav
  'nav.displays': 'Telas',
  'nav.content': 'Biblioteca de mídia',
  ...
  'dashboard.no_displays_desc': 'Instale o aplicativo Media Control na sua TV e pareie com o botão acima.',
  ...
  // Content library
  'content.title': 'Biblioteca de mídia',
  ...
  'settings.hide_branding': 'Ocultar marca "Media Control"',
  ...
  'settings.setup_step_1': 'Instale o APK do Media Control na sua TV via sideloading',
  ...
  'settings.import.invalid_file': 'Arquivo inválido. Deve ser JSON ou ZIP de exportação do Media Control.',
  ...
  'onboarding.step.welcome.title': 'Bem-vindo ao Media Control!',
  ...
  'admin.subtitle': 'Controles de administrador da plataforma - apenas você pode ver isso',
...
'mc.wb.dock_open': 'Whiteboard',
  ...
  'mc.cc.dock.program_ready': 'Programa pronto',
...
'mc.cc.confirm.start_live_title': 'Start classroom livestream',
  ...
  'mc.cc.live.prepared': 'A fonte do programa está conectada e pronta no OBS',
  'mc.cc.live.prepare_failed': 'Não foi possível preparar a fonte do programa OBS',
  ...
  'mc.send.live_display_only': 'Somente telas',
  'mc.send.live_content_main': 'Telas + transmissão: conteúdo principal / câmera PiP',
  'mc.send.live_camera_main': 'Telas + transmissão: câmera principal / conteúdo PiP',
  'mc.send.live_content_audio': 'Usar o áudio do conteúdo na transmissão',
  'mc.send.live_content_audio_warning': 'O áudio do conteúdo substitui o áudio da câmera da sala; as duas fontes nunca são misturadas.',
  'mc.send.live_playlist_unsupported': 'Listas de reprodução não podem ser enviadas ao compositor fixo.',
  'mc.send.live_failed': 'As telas foram atualizadas, mas a composição da transmissão não foi confirmada.',
  'mc.live.composition.aria': 'Composição no ar',
  'mc.live.composition.on_air': 'No ar',
  'mc.live.composition.on_air_revision': 'No ar · revisão {revision}',
  'mc.live.composition.camera_only': 'Somente câmera',
  'mc.live.composition.content_main': 'Conteúdo principal · Câmera PiP',
  'mc.live.composition.camera_main': 'Câmera principal · Conteúdo PiP',
  'mc.live.composition.remove': 'Remover conteúdo',
  'mc.live.composition.send_content_first': 'Envie conteúdo para a transmissão antes de selecionar PiP.',
  'mc.live.composition.changed': 'Composição no ar confirmada.',
  'mc.live.composition.removed': 'Conteúdo removido; Somente câmera confirmado.',
  'mc.live.composition.no_content': 'Não há conteúdo no ar para remover.',
  'mc.live.start.camera_only_confirm': 'Iniciar a transmissão com Somente câmera? O conteúdo poderá ser adicionado após a confirmação.',
...
'mc.cc.chip.from_server': 'From server',
  'mc.cc.cmd_not_ack': 'Comando não confirmado por {target} em 8s',
  'mc.cc.cmd_failed': 'Falha do comando em {target}',
};
