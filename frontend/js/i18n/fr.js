...
export default {
  ...
  'dashboard.no_displays_desc': 'Installez l\'application Media Control sur votre TV et appariez-la avec le bouton ci-dessus.',
  ...
  'settings.hide_branding': 'Masquer la marque « Media Control »',
  ...
  'settings.setup_step_1': 'Installez l\'APK Media Control sur votre TV via le sideloading',
  ...
  'settings.import.invalid_file': 'Fichier invalide. Doit être un JSON ou ZIP d\'export Media Control.',
  ...
  'onboarding.step.welcome.title': 'Bienvenue sur Media Control !',
  ...
  'admin.subtitle': 'Contrôles administrateur de plateforme - vous seul pouvez voir ceci',
  ...
  'admin.role.platform_admin': 'Administrateur de plateforme',
...
'mc.wb.dock_open': 'Whiteboard',
  ...
  'mc.cc.dock.prepare_live': 'Préparer le programme',
  'mc.cc.dock.program_ready': 'Programme prêt',
...
'mc.cc.confirm.start_live_title': 'Start classroom livestream',
  ...
  'mc.cc.live.prepared': 'La source du programme est connectée et prête dans OBS',
  'mc.cc.live.prepare_failed': 'Impossible de préparer la source du programme OBS',
  ...
  'mc.send.live_display_only': 'Écrans uniquement',
  'mc.send.live_content_main': 'Écrans + direct : contenu principal / caméra PiP',
  'mc.send.live_camera_main': 'Écrans + direct : caméra principale / contenu PiP',
  'mc.send.live_content_audio': 'Utiliser le son du contenu dans le direct',
  'mc.send.live_content_audio_warning': 'Le son du contenu remplace celui de la caméra de la salle ; les deux sources ne sont jamais mélangées.',
  'mc.send.live_playlist_unsupported': 'Les listes de lecture ne peuvent pas être envoyées au compositeur fixe.',
  'mc.send.live_failed': 'Les écrans ont été mis à jour, mais la composition du direct n’a pas été confirmée.',
  'mc.live.composition.aria': 'Composition à l’antenne',
  'mc.live.composition.on_air': 'À l’antenne',
  'mc.live.composition.on_air_revision': 'À l’antenne · révision {revision}',
  'mc.live.composition.camera_only': 'Caméra seule',
  'mc.live.composition.content_main': 'Contenu principal · Caméra PiP',
  'mc.live.composition.camera_main': 'Caméra principale · Contenu PiP',
  'mc.live.composition.remove': 'Retirer le contenu',
  'mc.live.composition.send_content_first': 'Envoyez d’abord un contenu vers le direct.',
  'mc.live.composition.changed': 'Composition à l’antenne confirmée.',
  'mc.live.composition.removed': 'Contenu retiré ; Caméra seule confirmée.',
  'mc.live.composition.no_content': 'Aucun contenu en direct à retirer.',
  'mc.live.start.camera_only_confirm': 'Démarrer le direct avec Caméra seule ? Le contenu pourra être ajouté une fois l’émetteur confirmé.',
...
'mc.cc.chip.from_server': 'From server',
  'mc.cc.cmd_not_ack': 'Commande non acquittée par {target} en 8s',
  'mc.cc.cmd_failed': 'Échec de la commande sur {target}',
};
