...
export default {
  ...
  'dashboard.no_displays_desc': 'Instala la aplicación de Media Control en tu TV y vincúlala con el botón de arriba.',
  ...
  // Visibilidad y ciclo de vida gobernados
  'content.filters_label': 'Filtros de gobierno de contenido',
  'content.filter_visibility': 'Filtrar por visibilidad',
  'content.filter_all_visibility': 'Toda visibilidad',
  'content.filter_type': 'Filtrar por tipo de medio',
  'content.filter_all_types': 'Todos los tipos',
  'content.filter_mine': 'Míos',
  'content.filter_archived': 'Incluir archivados',
  'content.visibility.private': 'Privado',
  'content.visibility.workspace_shared': 'Espacio de trabajo',
  'content.visibility.organization_shared': 'Organización',
  'content.visibility.platform_template': 'Plantilla de plataforma',
  'content.owner': 'Propietario',
  'content.owner_unknown': 'Propietario desconocido',
  'content.version': 'Versión {version}',
  'content.source_copy': 'Copia privada',
  'content.in_use': 'En uso: {count}',
  'content.btn_request_org': 'Solicitar a la organización',
  'content.request_pending': 'Aprobación pendiente',
  'content.btn_duplicate': 'Duplicar',
  'content.btn_transfer': 'Transferir propietario',
  'content.btn_assign_workspaces': 'Asignar espacios',
  'content.transfer_title': 'Transferir propiedad del contenido',
  'content.transfer_save': 'Transferir',
  'content.transfer_owner_label': 'Nuevo propietario',
  'content.transfer_owner_placeholder': 'Seleccione un miembro elegible',
  'content.transfer_warning': 'El nuevo propietario recibe el control de este contenido. La visibilidad y las rutas activas no cambian.',
  'content.transfer_empty': 'No hay miembros elegibles',
  'content.transfer_empty_desc': 'Agregue otro miembro del espacio u organización antes de transferir la propiedad.',
  'content.transfer_failed': 'No se pudieron cargar los propietarios elegibles',
  'content.template_assignments_title': 'Asignaciones del modelo a espacios',
  'content.template_assignments_save': 'Guardar asignaciones',
  'content.template_assignments_desc': 'Solo los espacios asignados pueden descubrir y usar esta plantilla. Quite las rutas activas antes de revocar una asignación.',
  'content.template_assignments_empty': 'No hay espacios disponibles',
  'content.template_assignments_failed': 'No se pudieron cargar las asignaciones',
  'content.btn_archive': 'Archivar',
  'content.btn_restore': 'Restaurar',
  'content.label_visibility': 'Visibilidad',
  'content.visibility_hint': 'Solo aparecen los niveles de visibilidad que tienes autorización para publicar.',
  'content.confirm_archive': '¿Archivar este contenido? Ya no estará disponible para nuevas asignaciones.',
  'content.confirm_restore': '¿Restaurar este contenido a la biblioteca activa?',
  'content.in_use_title': 'El contenido está actualmente en uso',
  'content.in_use_desc': 'Quita este elemento de sus {count} referencias activas antes de archivarlo.',
  'content.usage_playlists': 'Listas de reproducción',
  'content.usage_displays': 'Asignaciones directas a pantallas',
  'content.usage_routes': 'Otras rutas activas',
  'content.review_requests': 'Revisar solicitudes de publicación',
  'content.review_title': 'Solicitudes de publicación de la organización',
  'content.review_desc': 'Aprueba únicamente contenido preciso y adecuado para reutilización en toda la organización.',
  'content.review_empty': 'No hay solicitudes pendientes',
  'content.review_empty_desc': 'Las nuevas solicitudes de publicación aparecerán aquí.',
  'content.review_failed': 'No se pudieron cargar las solicitudes',
  'content.review_reason_prompt': 'Nota de decisión (opcional):',
  'content.approve': 'Aprobar',
  'content.reject': 'Rechazar',
  'content.toast.publication_requested': 'Solicitud de publicación enviada',
  'content.toast.duplicated': 'Copia privada creada',
  'content.toast.transferred': 'Propiedad del contenido transferida',
  'content.toast.template_assignments_saved': 'Asignaciones de plantilla guardadas',
  'content.toast.archived': 'Contenido archivado',
  'content.toast.restored': 'Contenido restaurado',
  'content.toast.approved': 'Solicitud aprobada',
  'content.toast.rejected': 'Solicitud rechazada',
  ...
  'settings.hide_branding': 'Ocultar la marca "Media Control"',
  ...
  'settings.setup_step_1': 'Instala el APK de Media Control en tu TV mediante sideloading',
  ...
  'settings.import.invalid_file': 'Archivo no válido. Debe ser un JSON o ZIP de exportación de Media Control.',
  ...
  'onboarding.step.welcome.title': '¡Bienvenido a Media Control!',
  ...
  // Command Center whiteboard (mc.wb.*) — untranslated stubs; en fallback otherwise.
...
'mc.wb.dock_open': 'Whiteboard',
  ...
  'mc.cc.dock.prepare_live': 'Preparar programa',
  'mc.cc.dock.program_ready': 'Programa listo',
...
'mc.cc.confirm.start_live_title': 'Start classroom livestream',
  ...
  'mc.cc.live.prepared': 'La fuente del programa está conectada y lista en OBS',
  'mc.cc.live.prepare_failed': 'No se pudo preparar la fuente del programa de OBS',
  ...
  // Live-stream inclusion 3-button prompt (broadcast funnel)
  ...
  'mc.send.live_display_only': 'Solo pantallas',
  'mc.send.live_content_main': 'Pantallas + directo: Contenido principal / Cámara PiP',
  'mc.send.live_camera_main': 'Pantallas + directo: Cámara principal / Contenido PiP',
  'mc.send.live_content_audio': 'Usar el audio del contenido en el directo',
  'mc.send.live_content_audio_warning': 'El audio del contenido sustituye al audio de la cámara del aula; las dos fuentes nunca se mezclan.',
  'mc.send.live_playlist_unsupported': 'Las listas no se pueden enviar al compositor fijo.',
  'mc.send.live_failed': 'Las pantallas se actualizaron, pero no se confirmó la composición en directo.',
  'mc.live.composition.aria': 'Composición en directo',
  'mc.live.composition.on_air': 'En directo',
  'mc.live.composition.on_air_revision': 'En directo · revisión {revision}',
  'mc.live.composition.camera_only': 'Solo cámara',
  'mc.live.composition.content_main': 'Contenido principal · Cámara PiP',
  'mc.live.composition.camera_main': 'Cámara principal · Contenido PiP',
  'mc.live.composition.remove': 'Quitar contenido',
  'mc.live.composition.send_content_first': 'Envíe contenido al directo antes de seleccionar PiP.',
  'mc.live.composition.changed': 'Composición en directo confirmada.',
  'mc.live.composition.removed': 'Contenido retirado; Solo cámara confirmado.',
  'mc.live.composition.no_content': 'No hay contenido en directo para quitar.',
  'mc.live.start.camera_only_confirm': '¿Iniciar el directo con Solo cámara? Podrá añadir contenido cuando el emisor esté confirmado.',
...
'mc.cc.chip.from_server': 'From server',
  'mc.cc.cmd_not_ack': 'Comando no confirmado por {target} en 8s',
  'mc.cc.cmd_failed': 'Comando fallido en {target}',
};
