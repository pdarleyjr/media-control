...
export default {
  ...
  'nav.content': 'Libreria multimediale',
  ...
  'dashboard.no_displays_desc': 'Installa l\'app Media Control sulla tua TV e associala usando il pulsante sopra.',
  ...
  // Content library
  'content.title': 'Libreria multimediale',
  ...
  'settings.hide_branding': 'Nascondi branding "Media Control"',
  ...
  'settings.setup_step_1': 'Installa l\'APK di Media Control sulla tua TV tramite sideloading',
  ...
  'settings.import.invalid_file': 'File non valido. Deve essere un file JSON o ZIP esportato da Media Control.',
  ...
  'onboarding.step.welcome.title': 'Benvenuto su Media Control!',
...
'mc.wb.dock_open': 'Whiteboard',
  ...
  'mc.cc.dock.prepare_live': 'Prepara programma',
  'mc.cc.dock.program_ready': 'Programma pronto',
...
'mc.cc.confirm.start_live_title': 'Start classroom livestream',
  ...
  'mc.cc.live.prepared': 'La sorgente del programma è connessa e pronta in OBS',
  'mc.cc.live.prepare_failed': 'Impossibile preparare la sorgente del programma OBS',
  ...
  'mc.send.live_display_only': 'Solo schermi',
  'mc.send.live_content_main': 'Schermi + diretta: contenuto principale / camera PiP',
  'mc.send.live_camera_main': 'Schermi + diretta: camera principale / contenuto PiP',
  'mc.send.live_content_audio': 'Usa l’audio del contenuto nella diretta',
  'mc.send.live_content_audio_warning': 'L’audio del contenuto sostituisce quello della camera in aula; le due sorgenti non vengono mai miscelate.',
  'mc.send.live_playlist_unsupported': 'Le playlist non possono essere inviate al compositore fisso.',
  'mc.send.live_failed': 'Gli schermi sono stati aggiornati, ma la composizione in diretta non è stata confermata.',
  'mc.live.composition.aria': 'Composizione in onda',
  'mc.live.composition.on_air': 'In onda',
  'mc.live.composition.on_air_revision': 'In onda · revisione {revision}',
  'mc.live.composition.camera_only': 'Solo camera',
  'mc.live.composition.content_main': 'Contenuto principale · Camera PiP',
  'mc.live.composition.camera_main': 'Camera principale · Contenuto PiP',
  'mc.live.composition.remove': 'Rimuovi contenuto',
  'mc.live.composition.send_content_first': 'Invia prima un contenuto alla diretta.',
  'mc.live.composition.changed': 'Composizione in onda confermata.',
  'mc.live.composition.removed': 'Contenuto rimosso; Solo camera confermato.',
  'mc.live.composition.no_content': 'Nessun contenuto in diretta da rimuovere.',
  'mc.live.start.camera_only_confirm': 'Avviare la diretta con Solo camera? Il contenuto potrà essere aggiunto dopo la conferma.',
...
'mc.cc.chip.from_server': 'From server',
  'mc.cc.cmd_not_ack': 'Comando non confermato da {target} entro 8s',
  'mc.cc.cmd_failed': 'Comando non riuscito su {target}',
};
