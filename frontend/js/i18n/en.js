...
export default {
  ...
  'mc.routing.group_title': 'Each display shows its own content (default)',
  'mc.routing.lecture': 'Lecture',
  'mc.routing.lecture_title': 'Send one source to every display on the stage',
  'mc.routing.mirror': 'Mirror',
  'mc.routing.mirror_title': 'Clone the first display to all the others',
  'mc.routing.lecture_hint_empty': 'Add displays to the stage first. Lecture mode then sends one source to all of them.',
  'mc.routing.lecture_hint': 'Lecture mode on. Tap any source to send it to all {n} displays at once.',
  ...
  'mc.tb.templates_hint': 'Select a display above, then choose Partition into regions in the inspector to split it into a layout.',
  ...
  'mc.insp.audio': 'Region audio',
  'mc.insp.audio_hint': 'Only one region plays audio at a time.',
  'mc.insp.region_fallback': 'Region',
  'mc.insp.audio_on': 'Audio',
  'mc.insp.audio_muted': 'Muted',
  'mc.insp.audio_switch': 'Another region already had audio. Only one region plays sound at a time, so audio moved here.',
  'mc.insp.fit_set': 'Fit set to "{mode}" for the next send.',
