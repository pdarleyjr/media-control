...
export default {
  ...
  'mc.canvas.room_camera': 'Room camera',
  ...
  'mc.canvas.camera_waiting': 'Requesting a frame from the WyreStorm room camera…',
  'mc.canvas.camera_failed': 'The room camera did not return a frame.',
  ...
  // Camera Feeds tab
  'mc.cf.hint': 'Drag a camera onto a display, or tap to choose where it plays.',
  'mc.cf.empty': 'No camera feeds available.',
  'mc.cf.snapshot': 'Live snapshot',
  'mc.cf.focus_control': 'Focus 210 digital PTZ',
  'mc.cf.focus_control_hint': 'View the live room camera and select Wide or Video Wall 2, or adjust pan and zoom.',
  'mc.cf.open_control': 'Open camera controls',
  'mc.cf.focus_control_title': 'Focus 210 Camera Controls',
  ...
  'mc.cf.group.marine': 'Port & Marine',
  'mc.cf.group.miami': 'Miami Cams',
  ...
  'mc.cc.camera.active': 'Cam {n} active · {count} online',
