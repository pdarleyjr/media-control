  ...
  container.innerHTML = `
    ...
    <div class="settings-section">
      ...
      ${[
        ...
        { q: 'Can I self-host Media Control?', a: 'Yes! Deploy the server on your own infrastructure. All data stays on your network. Set SELF_HOSTED=true in the environment.' },
